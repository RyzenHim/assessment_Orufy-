...
const TopBar = ({ profile, onLogout, onMenuToggle = () => { } }) => {
    ...
    return (
        <header className='fixed left-0 right-0 top-0 z-50 md:left-60'>
                ...
                <div className='flex h-16 items-center justify-between gap-4 px-5 md:px-6'>
                    <div className='flex items-center gap-3'>
                        ...
                        <button
                            ...
                            className='md:hidden cursor-pointer rounded-lg p-2 hover:bg-[#f0f2f7]'
                    ...
                    <div className='flex items-center gap-3'>
                        <div className='hidden h-11 w-[340px] items-center gap-3 rounded-md bg-white/80 px-4 text-[#8792a9] ring-1 ring-inset ring-[#eef1f7] lg:flex'>
                            <SearchIcon />
